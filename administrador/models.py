...
class Empleado(models.Model):
    ...
    rut_persona = models.ForeignKey(
        Persona, on_delete=models.CASCADE, default=0)
...
class Catalogos(models.Model):  # steve
    nombre = models.CharField(max_length=100, default='')
    imgCatalogo = models.ImageField(
        default='null', upload_to="fotosPostres")  # upload_to='fotosImg'

    class Meta:
        # Le doy de nombre 'postres' a nuestra tabla en la Base de Datos
...
class Cafe(models.Model):
    ...
    def __str__(self):
        return self.codCafe, self.nombre
...
class CafeForm(ModelForm):
    class Meta:
        model = Cafe
        fields = ['codCafe', 'descripcion', 'nombre']
